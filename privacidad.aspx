<%@ Page Title="" Language="VB" MasterPageFile="~/mpInterna.master" AutoEventWireup="false" CodeFile="privacidad.aspx.vb" Inherits="privacidad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipalInterna" Runat="Server">
     <div class="privacidad">
         <div class="titulo" style="padding:2%;"><h2>Aviso de Privacidad</h2></div>
         <div class="aviso" style="padding:2%; text-align:justify;"><strong>El pasaje estándar Lorem Ipsum, usado desde el año 1500.

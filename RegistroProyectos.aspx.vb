...
#Region "Proyectos"
    ...
    Protected Sub grdvProyectos_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles grdvProyectos.RowEditing
        ...
        odsProyecto.FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & CurrentCveProyecto & "'"
        grdvProyectos.DataBind()
        e.NewEditIndex = 0
    End Sub
    ...
    Protected Sub grdvProyectos_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles grdvProyectos.RowUpdating
        ...
        Try
            ...
            'Los demas valores los tomara de los componentes del formulario por default

            'taProyecto.Update( _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlTipoApoyoEdt"), DropDownList).SelectedValue, _
            '    Date.Now, _
            '    dtFehcaCaptura, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtNombreEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlAnioConvEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlInstitucionEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlTipoProyectoEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtResumenEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlRegionSegEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlEscalaEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlVegetacionEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtMetodologiaEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlEstatusEdt"), DropDownList).SelectedValue, _
            '    CInt(taObjeto.GetCveObjetoByCveTipoApoyo(CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlTipoProyectoEdt"), DropDownList).SelectedValue)), _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtDemandaEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("uppaFechaConvenioAcuerdoEdt").FindControl("dpkrFechaConvAcueEdt"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlEcosistemaEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtResEsperadosEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtDemandanteEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtIdentProblemaEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlAreaTematicaEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtCoberturaOperativaEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtImpactosEsperadosEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlSectorUsuarioTTEdt"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtMaterialesTTEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtUsuarioTTEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtRequisitosTTEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtActividadesTTEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtObjetivoGralEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtObjetivosEspEdt"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(e.RowIndex).FindControl("ddlResponsableTecnicoEdt"), DropDownList).SelectedValue, _
            '    CSng(CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtCostoTotalProyectoEdt"), TextBox).Text), _
            '    CSng(CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtAportacionApoyoInstitucionalEdt"), TextBox).Text), _
            '    CSng(CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtAportacionInstitucionEjecutoraEdt"), TextBox).Text), _
            '    CSng(CType(grdvProyectos.Rows(e.RowIndex).FindControl("txtAportacionesOtrasEdt"), TextBox).Text), _
            '    grdvProyectos.DataKeys(e.RowIndex).ToString _
            '    )
    ...
    'Protected Sub grdvProyectos_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles grdvProyectos.RowDeleting
    '    Dim taProyecto As New dsAppTableAdapters.ProyectoTableAdapter
    '    Try

    '        taProyecto.Delete(grdvProyectos.DataKeys(e.RowIndex).Value)
    '        grdvProyectos.DataBind()

    '    Catch concurrencyEx As DBConcurrencyException

    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch constraintEx As ConstraintException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Error de llaves duplicadas"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch deletedRowEx As DeletedRowInaccessibleException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Fila no accesible"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Fila no accesible"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch duplicateNameEx As DuplicateNameException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Nombre duplicado"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Nombre duplicado"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch inRowChangingEx As InRowChangingEventException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Fila esta siendo modificada"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch invalidConstraintEx As InvalidConstraintException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Restricción no válida"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Restricción no válida"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch invalidExpressionEx As InvalidExpressionException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Expresión no válida"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Expresión no válida"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch missingPrimaryEx As MissingPrimaryKeyException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "No se encontró una llave principal"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch noNullEx As NoNullAllowedException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Valor nulo no permitido"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch readOnlyEx As ReadOnlyException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch rowNotInTableEx As RowNotInTableException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch strongTypingEx As StrongTypingException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Error en tipos de datos"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Error en tipos de datos"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch typedDataSetEx As TypedDataSetGeneratorException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch versionNotFoundEx As VersionNotFoundException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Versión no encontrada"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Versión no encontrada"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch dataEx As DataException
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Error de datos"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Error de datos"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Catch ex As Exception
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
    '        CType(grdvProyectos.Rows(e.RowIndex).FindControl("cuvEliminar"), CustomValidator).IsValid = False
    '    Finally
    '        taProyecto.Dispose()
    '    End Try
    ...
    Protected Sub ibtnActualizarAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtnActualizarAdd.Click
        ...
        Try
            ...
            txtBusqueda.Text = txtCveCONACYT.Text
            odsProyecto.DataBind()
            grdvProyectos.DataBind()
            mviewProyectos.SetActiveView(viewLista)
            ClearFieldAdding()
    ...
    Protected Sub frmvProyecto_Detalle_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles frmvProyecto_Detalle.DataBound
        CType(frmvProyecto_Detalle.FindControl("ResumenLabel"), Label).Text = CType(frmvProyecto_Detalle.FindControl("ResumenLabel"), Label).Text.Replace(Chr(13) & Chr(10), "<br>")
        CType(frmvProyecto_Detalle.FindControl("lblMetodologiaST"), Label).Text = CType(frmvProyecto_Detalle.FindControl("lblMetodologiaST"), Label).Text.Replace(Chr(13) & Chr(10), "<br>")
        CType(frmvProyecto_Detalle.FindControl("lblObjetivosEspecificosST"), Label).Text = CType(frmvProyecto_Detalle.FindControl("lblObjetivosEspecificosST"), Label).Text.Replace(Chr(13) & Chr(10), "<br>")
        CType(frmvProyecto_Detalle.FindControl("lblResultadosEspST"), Label).Text = CType(frmvProyecto_Detalle.FindControl("lblResultadosEspST"), Label).Text.Replace(Chr(13) & Chr(10), "<br>")
        CType(frmvProyecto_Detalle.FindControl("lblObjetivoGeneralST"), Label).Text = CType(frmvProyecto_Detalle.FindControl("lblObjetivoGeneralST"), Label).Text.Replace(Chr(13) & Chr(10), "<br>")
...
#Region "ProyectoParticipante"
    ...
    Private Sub LimpiarParticipante()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlParticipantePPAdd"), DropDownList).SelectedIndex = -1
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlTipoParticipantePPAdd"), DropDownList).SelectedIndex = -1
    ...
    Private Sub SelPestaniaParticipantes()
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEtapasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_et_rep.gif"
        '**ELIMINADO** CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnProblematicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pr_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnParticipantesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pa_sel.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEspeciesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_es_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEstadosEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_st_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dm_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dd_rep.gif"
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewParticipantesEdt"), View))
    End Sub
    ...
    Protected Sub dtlParticipantesPP_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlParticipantesPPAdd"), Panel).Visible = False
        LimpiarParticipante()
    ...
    Protected Sub dtlParticipantesPP_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoParticipante.Delete(CType(source, DataList).DataKeys(e.Item.ItemIndex), grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlParticipantesPPAdd"), Panel).Visible = False
            LimpiarParticipante()
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaParticipantes()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:002"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub dtlParticipantesPP_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlParticipantesPPAdd"), Panel).Visible = False
        LimpiarParticipante()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsProyectoParticipante"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames.ToString & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
    ...
    Protected Sub dtlParticipantesPP_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoParticipante.UpdateCveTipoParticipante( _
                ...
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(source, DataList).EditItemIndex = -1
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
    ...
    Protected Sub ibtnAgregarPP_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlParticipantesPPAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlParticipantesPPAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnInsertarPPAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taProyectoParticipante.Insert( _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlParticipantePPAdd"), DropDownList).SelectedValue, _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlTipoParticipantePPAdd"), DropDownList).SelectedValue)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlParticipantesPPAdd"), Panel).Visible = False
            LimpiarParticipante()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlParticipantesPP"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaParticipantes()
        Catch concurrencyEx As DBConcurrencyException
        ...
        Catch dataEx As DataException
            ...
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:004"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvParticipantesPPAdd"), CustomValidator).IsValid = False
        Finally
            taProyectoParticipante.Dispose()
...
#Region "ProyectoEspecie"
    ...
    Private Sub LimpiarEspecie()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlEspeciePEAdd"), DropDownList).SelectedIndex = -1
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNombreComunPEAdd"), TextBox).Text = String.Empty
    End Sub
    ...
    Private Sub SelPestaniaEspecies()
        ...
        '**ELIMINADO** CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnProblematicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pr_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnParticipantesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pa_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEspeciesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_es_sel.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEstadosEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_st_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dm_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dd_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_vt_rep.gif"
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewEspeciesEdt"), View))
    End Sub
    ...
    Protected Sub dtlEspeciesPE_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEspeciesPEAdd"), Panel).Visible = False
        LimpiarEspecie()
        CType(source, DataList).EditItemIndex = -1
        CType(source, DataList).DataBind()
        'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
    ...
    Protected Sub dtlEspeciesPE_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoEspecie.Delete(grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEspeciesPEAdd"), Panel).Visible = False
            LimpiarEspecie()
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            ...
            'SelPestaniaEspecies()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:005"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub dtlEspeciesPE_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEspeciesPEAdd"), Panel).Visible = False
        LimpiarEspecie()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsEspeciePE"), ObjectDataSource).FilterExpression = "CveProyecto = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND CveEspecie = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub ibtnNuevoProyectoEspeciesAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEspeciesPEAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEspeciesPEAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPEAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taProyectoEspecie.Insert( _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlEspeciePEAdd"), DropDownList).SelectedValue, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNombreComunPEAdd"), TextBox).Text)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEspeciesPEAdd"), Panel).Visible = False
            LimpiarEspecie()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEspeciesPE"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaEspecies()
        Catch concurrencyEx As DBConcurrencyException
        ...
        Catch dataEx As DataException
            ...
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:007"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEspeciePEAdd"), CustomValidator).IsValid = False
        Finally
            taProyectoEspecie.Dispose()
...
#Region "ProyectoDifusionDivulgacion"
    ...
    Private Sub LimpiarDifusion()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlTipoDifusionDDAdd"), DropDownList).SelectedIndex = -1
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInicioDDAdd"), UpdatePanel).FindControl("dtpkFechaInicioDDAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInicioDDAdd"), UpdatePanel).FindControl("dtpkFechaFinDDAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtDescripcionDDAdd"), TextBox).Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtSegmentoPobDDAdd"), TextBox).Text = String.Empty
    End Sub
    ...
    Private Sub SelPestaniaDifusionDivulga()
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEstadosEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_st_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dm_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dd_sel.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_vt_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_sg_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewDifusionDivulgaEdt"), View))
    End Sub
    ...
    Protected Sub dtlActividadesDD_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDifDivAdd"), Panel).Visible = False
        LimpiarDifusion()
        CType(source, DataList).EditItemIndex = -1
    ...
    Protected Sub dtlActividadesDD_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoDifDiv.Delete(grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex), CType(CType(source, DataList).Controls.Item(e.Item.ItemIndex + 1).FindControl("hdnConsecutivoDDEdt"), HiddenField).Value)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDifDivAdd"), Panel).Visible = False
            LimpiarDifusion()
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            ...
            'SelPestaniaDifusionDivulga()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:008"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub dtlActividadesDD_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDifDivAdd"), Panel).Visible = False
        LimpiarDifusion()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsActividadesDD"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames.ToString & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub dtlActividadesDD_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            ...
            taProyectoDifDiv.ActualizarDifusionDivulgacion( _
                ...
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex), _
    ...
    Protected Sub ibtnNuevoDDAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDifDivAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDifDivAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnInsertarDD_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Dim dtFechaFin As New System.Nullable(Of Date)
        Dim numBene As Integer
        If CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNumeroBeneficiariosAdd"), TextBox).Text = "" Then
            numBene = Nothing
        Else
            numBene = Convert.ToInt32(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNumeroBeneficiariosAdd"), TextBox).Text)
        End If

        Try
            If CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInicioDDAdd"), UpdatePanel).FindControl("dtpkFechaInicioDDAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty Then dtFechaInicio = Nothing Else dtFechaInicio = CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInicioDDAdd"), UpdatePanel).FindControl("dtpkFechaInicioDDAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text)
            If CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInicioDDAdd"), UpdatePanel).FindControl("dtpkFechaFinDDAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty Then dtFechaFin = Nothing Else dtFechaFin = CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInicioDDAdd"), UpdatePanel).FindControl("dtpkFechaFinDDAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text)
            taProyectoDifDiv.Insert( _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlTipoDifusionDDAdd"), DropDownList).SelectedValue, _
                dtFechaInicio, _
                dtFechaFin, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtDescripcionDDAdd"), TextBox).Text, _
                numBene, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtSegmentoPobDDAdd"), TextBox).Text)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDifDivAdd"), Panel).Visible = False
            LimpiarDifusion()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlActividadesDD"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaDifusionDivulga()
        Catch concurrencyEx As DBConcurrencyException
        ...
        Catch dataEx As DataException
            ...
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:010"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDifDivDDAdd"), CustomValidator).IsValid = False
        Finally
            taProyectoDifDiv.Dispose()
...
#Region "ProyectoMontoDetalle"
    ...
    Private Sub LimpiarMontoDetalle()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtConceptoPMAdd"), TextBox).Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtCantidadPMAdd"), TextBox).Text = String.Empty
    End Sub
    ...
    Private Sub SelPestaniaDetalleMonto()
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEspeciesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_es_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEstadosEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_st_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dm_sel.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dd_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_vt_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_sg_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewDetalleMontoEdt"), View))
    End Sub
    ...
    Protected Sub dtlProyectoDetalleMonto_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDetMontoAdd"), Panel).Visible = False
        LimpiarMontoDetalle()
        CType(source, DataList).EditItemIndex = -1
        CType(source, DataList).SelectedIndex = -1
        CType(source, DataList).DataBind()
    ...
    Protected Sub dtlProyectoDetalleMonto_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoMonto.Delete(grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDetMontoAdd"), Panel).Visible = False
            LimpiarMontoDetalle()
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            ...
            'SelPestaniaDetalleMonto()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:011"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub dtlProyectoDetalleMonto_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDetMontoAdd"), Panel).Visible = False
        LimpiarMontoDetalle()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsProyectoDetalleMonto"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub dtlProyectoDetalleMonto_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDetMontoAdd"), Panel).Visible = False
        LimpiarMontoDetalle()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsProyectoDetalleMonto"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(sender, DataList).DataKeyField.ToString & " = " & CType(sender, DataList).DataKeys(CType(sender, DataList).SelectedIndex)
    ...
    Protected Sub ibtnNuevoPMAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDetMontoAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDetMontoAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPMAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taDetalleMonto.InsertarConcepto( _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtConceptoPMAdd"), TextBox).Text, _
                CDec(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtCantidadPMAdd"), TextBox).Text))
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlDetMontoAdd"), Panel).Visible = False
            LimpiarMontoDetalle()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoDetalleMonto"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaDetalleMonto()
        Catch concurrencyEx As DBConcurrencyException
        ...
        Catch dataEx As DataException
            ...
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:013"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDetalleMontoPMAdd"), CustomValidator).IsValid = False
        Finally
...
#Region "ProyectoProgramaPago"
    ...
    Protected Sub dtlProyectoProgPagoPG_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            ...
            '    grdvProyectos.DataKeys(grdvProyectos.EditIndex), CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(source, DataList).EditItemIndex = -1
            CType(source, DataList).DataBind()
    ...
    Protected Sub ibtnGuardarPGAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Dim CveProyecto As String = CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("hdCveProyectoAdmEdt"), HiddenField).Value
        ...
        Try
            ...
            '    grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtMontoPGAdd"), TextBox).Text, _
            '    CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpGastoPGAdd"), UpdatePanel).FindControl("ddlGastoPGAdd"), DropDownList).SelectedValue, _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaProgPGAdd"), UpdatePanel).FindControl("dtpkFechaProgPGAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaRealPGAdd"), UpdatePanel).FindControl("dtpkFechaRealPGAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaSolPGAdd"), UpdatePanel).FindControl("dtpkFechaSolPGAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtClabePGAdd"), TextBox).Text, _
            '    CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpEdoMpioPGAdd"), UpdatePanel).FindControl("ddlMpioPGAdd"), DropDownList).SelectedValue, _
            '    CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpEdoMpioPGAdd"), UpdatePanel).FindControl("ddlEstadoPGAdd"), DropDownList).SelectedValue, _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNumFacturaPGAdd"), TextBox).Text, _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaEntPGAdd"), UpdatePanel).FindControl("dtpkFechaEntPGAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaConPGAdd"), UpdatePanel).FindControl("dtpkFechaConPGAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtObservacionesPGAdd"), TextBox).Text)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProgramaPagoPPAdd"), Panel).Visible = False
            LimpiarProgramaPago()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoProgPagoPG"), DataList).DataBind()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:016"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Finally
            taAdmPago.Dispose()
        End Try
...
#Region "ProyectoProblematica"
    ...
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlProblematicaPBAdd"), DropDownList).SelectedIndex = -1
    'End Sub

    'Private Sub SelPestaniaProblematica()
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDatosGeneralesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dg_rep.gif"
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEtapasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_et_rep.gif"
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnProblematicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pr_sel.gif"
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnParticipantesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pa_rep.gif"
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEspeciesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_es_rep.gif"
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEstadosEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_st_rep.gif"
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dm_rep.gif"
    ...
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewProblematicasEdt"), View))
    'End Sub
    ...
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProblematicaPBAdd"), Panel).Visible = False
    '    LimpiarProblematica()
    '    CType(source, DataList).EditItemIndex = -1
    '    CType(source, DataList).SelectedIndex = -1
    '    CType(source, DataList).DataBind()
    ...
    '    Try
    '        taProyectoProblematica.Delete(grdvProyectos.DataKeys(grdvProyectos.EditIndex), CType(source, DataList).DataKeys(e.Item.ItemIndex))
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProblematicaPBAdd"), Panel).Visible = False
    '        LimpiarProblematica()
    '        CType(source, DataList).DataBind()
    '        'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
    ...
    '        'SelPestaniaProblematica()
    '    Catch concurrencyEx As DBConcurrencyException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch constraintEx As ConstraintException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch deletedRowEx As DeletedRowInaccessibleException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Fila no accesible"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch duplicateNameEx As DuplicateNameException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Nombre duplicado"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch inRowChangingEx As InRowChangingEventException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch invalidConstraintEx As InvalidConstraintException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Restricción no válida"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch invalidExpressionEx As InvalidExpressionException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Expresión no válida"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch missingPrimaryEx As MissingPrimaryKeyException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch noNullEx As NoNullAllowedException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch readOnlyEx As ReadOnlyException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch rowNotInTableEx As RowNotInTableException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch strongTypingEx As StrongTypingException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch typedDataSetEx As TypedDataSetGeneratorException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch versionNotFoundEx As VersionNotFoundException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Versión no encontrada"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch dataEx As DataException
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Error de datos"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Error de datos"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch ex As Exception
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:017"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Finally
    ...
    '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProblematicaPBAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProblematicaPBAdd"), Panel).Visible
    'End Sub
    ...
    '            grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
    '            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlProblematicaPBAdd"), DropDownList).SelectedValue)
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProblematicaPBAdd"), Panel).Visible = False
    '        LimpiarProblematica()
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProblematicaPB"), DataList).DataBind()
    '        'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
    '        'grdvProyectos.DataBind()
    '        'SelPestaniaProblematica()
    '    Catch concurrencyEx As DBConcurrencyException
    ...
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Catch ex As Exception
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:018"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
    '        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvProblematicaPBAdd"), CustomValidator).IsValid = False
    '    Finally
...
#Region "ProyectoEstado"
    ...
    Private Sub LimpiarEstado()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlEstadoPSAdd"), DropDownList).SelectedIndex = -1
    End Sub
    ...
    Private Sub SelPestaniaEstado()
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnParticipantesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pa_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEspeciesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_es_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEstadosEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_st_sel.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dm_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dd_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_vt_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_sg_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewEstadosEdt"), View))
    End Sub
    ...
    Protected Sub dtlProyectoEstadosPS_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEstadoPSAdd"), Panel).Visible = False
        LimpiarEstado()
        CType(source, DataList).EditItemIndex = -1
        CType(source, DataList).SelectedIndex = -1
        CType(source, DataList).DataBind()
    ...
    Protected Sub dtlProyectoEstadosPS_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoEstado.Delete(grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEstadoPSAdd"), Panel).Visible = False
            LimpiarEstado()
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            ...
            'SelPestaniaEstado()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:019"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub ibtnNuevoPSAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEstadoPSAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEstadoPSAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPSAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taEstado.Insert( _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlEstadoPSAdd"), DropDownList).SelectedValue)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlEstadoPSAdd"), Panel).Visible = False
            LimpiarEstado()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoEstadosPS"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaEstado()
        Catch concurrencyEx As DBConcurrencyException
        ...
        Catch dataEx As DataException
            ...
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:020"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvEstadoPSAdd"), CustomValidator).IsValid = False
        Finally
            taEstado.Dispose()
...
#Region "ProyectoAsunto"
    ...
    Private Sub LimpiarAsunto()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtDescAsuntoPTAdd"), TextBox).Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlEstatusAsuntoPTAdd"), DropDownList).SelectedIndex = -1
    End Sub
    ...
    Private Sub SelPestaniaSeguimiento()
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dd_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_vt_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_sg_sel.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewSeguimientoEdt"), View))
    End Sub
    ...
    Protected Sub dtlProyectoAsuntosPT_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoAsuntoPTAdd"), Panel).Visible = False
        CurrentCveAsunto = -1
        LimpiarAsunto()
        CType(source, DataList).SelectedIndex = -1
        CType(source, DataList).EditItemIndex = -1
    ...
    Protected Sub dtlProyectoAsuntosPT_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoAsunto.Delete(grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoAsuntoPTAdd"), Panel).Visible = False
            LimpiarAsunto()
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            ...
            'SelPestaniaSeguimiento()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:021"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub dtlProyectoAsuntosPT_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        LimpiarAsunto()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsProyectoAsuntosPT"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub ibtnNuevoPTAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoAsuntoPTAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoAsuntoPTAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPTAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taProyectoAsunto.InsertarAsunto( _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtDescAsuntoPTAdd"), TextBox).Text, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ddlEstatusAsuntoPTAdd"), DropDownList).SelectedValue)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoAsuntoPTAdd"), Panel).Visible = False
            LimpiarAsunto()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaSeguimiento()
        Catch concurrencyEx As DBConcurrencyException
        ...
        Catch dataEx As DataException
            ...
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:023"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvDescAsuntoPTAdd"), CustomValidator).IsValid = False
        Finally
            taProyectoAsunto.Dispose()
...
#Region "ProyectoAsuntoOficio"
    ...
    Private Sub LimpiarOficio()
        CType(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("updpFechaOficPAOAdd"), UpdatePanel).FindControl("dtpkFechaOficPAOAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("txtNumOficioPAOAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("txtRemitentePAOAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("txtDestinatarioPAOAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("txtDescOficioPAOAdd"), TextBox).Text = String.Empty
    End Sub

    Private Sub SelPestaniaAsuntosAsunto()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("odsProyAsuntoOficioPAO"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataKeyField.ToString & " = " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex)
        ...
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("mviewAsuntosOficiosPAO"), MultiView).SetActiveView(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("viewAsuntoPAO"), View))
    End Sub
    ...
    Protected Sub dtlProyAsuntoOficioPAO_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("pnlProyectoAsuntoOficioAdd"), Panel).Visible = False
        LimpiarOficio()
        CType(source, DataList).EditItemIndex = -1
        CType(source, DataList).SelectedIndex = -1
        CType(source, DataList).DataBind()
    ...
    Protected Sub dtlProyAsuntoOficioPAO_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoAsuntoOficio.Delete( _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex), _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
        ...
        Catch concurrencyEx As DBConcurrencyException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
        ...
        Catch noNullEx As NoNullAllowedException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
        ...
        Catch strongTypingEx As StrongTypingException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
    ...
    Protected Sub dtlProyAsuntoOficioPAO_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("pnlProyectoAsuntoOficioAdd"), Panel).Visible = False
        LimpiarOficio()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("odsProyAsuntoOficioPAO"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataKeyField.ToString & " = " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex) & " AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub dtlProyAsuntoOficioPAO_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("pnlProyectoAsuntoOficioAdd"), Panel).Visible = False
        LimpiarOficio()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("odsProyAsuntoOficioPAO"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataKeyField.ToString & " = " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex) & " AND " & CType(sender, DataList).DataKeyField.ToString & " = " & CType(sender, DataList).DataKeys(CType(sender, DataList).SelectedIndex)
        CType(sender, DataList).SelectedIndex = 0
        CType(sender, DataList).DataBind()
    ...
    Protected Sub ibtnNuevoPAOAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("pnlProyectoAsuntoOficioAdd"), Panel).Visible = Not CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("pnlProyectoAsuntoOficioAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPAOAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taProyectoAsuntoOficio.InsertarOficio( _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex), _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CDate(CType(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("updpFechaOficPAOAdd"), UpdatePanel).FindControl("dtpkFechaOficPAOAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("txtNumOficioPAOAdd"), TextBox).Text, _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("txtRemitentePAOAdd"), TextBox).Text, _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("txtDestinatarioPAOAdd"), TextBox).Text, _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("txtDescOficioPAOAdd"), TextBox).Text)
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("pnlProyectoAsuntoOficioAdd"), Panel).Visible = False
            LimpiarOficio()
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("dtlProyAsuntoOficioPAO"), DataList).DataBind()
            'SelPestaniaSeguimiento()
            'SelPestaniaAsuntosOficios()
        Catch concurrencyEx As DBConcurrencyException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoAsuntosPT"), DataList).EditItemIndex + 1).FindControl("cuvFechaOficPAOAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
...
#Region "ProyectoVisitasTecnicas"
    ...
    Private Sub LimpiarVisitaTecnica()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtInstalacionesPVAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpEdoMpioPVAdd"), UpdatePanel).FindControl("ddlEstadoPVAdd"), DropDownList).SelectedIndex = -1
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpEdoMpioPVAdd"), UpdatePanel).FindControl("ddlMpioPVAdd"), DropDownList).SelectedIndex = -1
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaVisPVAdd"), UpdatePanel).FindControl("dtpkFechaVisPVAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtAsistentesPVAdd"), TextBox).Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtAvanceGralPVAdd"), TextBox).Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("chkbEntregaProdsPVAdd"), CheckBox).Checked = False
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtObservacionesPVAdd"), TextBox).Text = String.Empty
    End Sub
    ...
    Private Sub SelPestaniaVisitas()
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dm_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dd_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_vt_sel.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_sg_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewVisitasTecnicasEdt"), View))
    End Sub
    ...
    Protected Sub dtlProyectoVisitasPV_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CurrentCveVisita = -1
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoVisitasPVAdd"), Panel).Visible = False
    ...
    Protected Sub dtlProyectoVisitasPV_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoVisita.Delete(grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoVisitasPVAdd"), Panel).Visible = False
            LimpiarVisitaTecnica()
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            ...
            'SelPestaniaVisitas()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:026"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub dtlProyectoVisitasPV_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        LimpiarVisitaTecnica()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsProyectoVisitasPV"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub dtlProyectoVisitasPV_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoVisitasPVAdd"), Panel).Visible = False
        LimpiarVisitaTecnica()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsProyectoVisitasPV"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(sender, DataList).DataKeyField.ToString & " = " & CType(sender, DataList).DataKeys(CType(sender, DataList).SelectedIndex)
        CType(sender, DataList).SelectedIndex = 0
        CType(sender, DataList).DataBind()
    ...
    Protected Sub ibtnNuevoPVAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoVisitasPVAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoVisitasPVAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPVAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taProyectoVisita.InsertarVisitaTecnica( _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtInstalacionesPVAdd"), TextBox).Text, _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpEdoMpioPVAdd"), UpdatePanel).FindControl("ddlEstadoPVAdd"), DropDownList).SelectedValue, _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpEdoMpioPVAdd"), UpdatePanel).FindControl("ddlMpioPVAdd"), DropDownList).SelectedValue.PadLeft(5, "0"c), _
                CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaVisPVAdd"), UpdatePanel).FindControl("dtpkFechaVisPVAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtAsistentesPVAdd"), TextBox).Text, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtAvanceGralPVAdd"), TextBox).Text, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("chkbEntregaProdsPVAdd"), CheckBox).Checked, _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtObservacionesPVAdd"), TextBox).Text)
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoVisitasPVAdd"), Panel).Visible = False
            LimpiarVisitaTecnica()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaVisitas()
        Catch concurrencyEx As DBConcurrencyException
        ...
        Catch dataEx As DataException
            ...
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:028"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Finally
            taProyectoVisita.Dispose()
...
#Region "ProyectoVisitaAcuerdo"
    Private Sub LimpiarAcuerdo()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("txtDescAcuerdoPVAAdd"), TextBox).Text = String.Empty
        CType(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("updpFechaVenPVAAdd"), UpdatePanel).FindControl("dtpkFechaVenPVAAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("chkbCumplidoPVAAdd"), CheckBox).Checked = False
    End Sub

    Private Sub SelPestaniaVisitasVisitas()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("ibtnProyectoVisitasPVEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_vt_sel.gif"
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("ibtnProyVisitasAcuerdosPVEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_va_rep.gif"
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("mviewVisitasAcuerdos"), MultiView).SetActiveView(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("viewVisitas"), View))
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsProyectoVisitasPV"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataKeyField.ToString & " = " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataBind()
    End Sub

    Private Sub SelPestaniaVisitasAcuerdos()
        'CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("odsProyVisitaAcuerdoPVA"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataKeyField.ToString & " = " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex)
    ...
    Protected Sub dtlProyVisitaAcuerdoPVA_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("pnlProyectoVisitaAcuerdoAdd"), Panel).Visible = False
        LimpiarAcuerdo()
        CType(source, DataList).EditItemIndex = -1
        CType(source, DataList).SelectedIndex = -1
        CType(source, DataList).DataBind()
    ...
    Protected Sub dtlProyVisitaAcuerdoPVA_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoVisitaAcuerdo.Delete(CType(source, DataList).DataKeys(e.Item.ItemIndex), _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex), _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value)
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("pnlProyectoVisitaAcuerdoAdd"), Panel).Visible = False
            LimpiarAcuerdo()
            CType(source, DataList).DataBind()
            'CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataBind()
        ...
        Catch concurrencyEx As DBConcurrencyException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
        ...
        Catch invalidConstraintEx As InvalidConstraintException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
        ...
        Catch noNullEx As NoNullAllowedException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
        ...
        Catch strongTypingEx As StrongTypingException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
        ...
        Catch versionNotFoundEx As VersionNotFoundException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
    ...
    Protected Sub dtlProyVisitaAcuerdoPVA_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("pnlProyectoVisitaAcuerdoAdd"), Panel).Visible = False
        LimpiarAcuerdo()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("odsProyVisitaAcuerdoPVA"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataKeyField.ToString & " = " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex) & " AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub ibtnNuevoPVAAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("pnlProyectoVisitaAcuerdoAdd"), Panel).Visible = Not CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("pnlProyectoVisitaAcuerdoAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPVAAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taProyectoVisitaAcuerdo.InsertarAcuerdo( _
                CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex), _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("txtDescAcuerdoPVAAdd"), TextBox).Text, _
                CDate(CType(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("updpFechaVenPVAAdd"), UpdatePanel).FindControl("dtpkFechaVenPVAAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("chkbCumplidoPVAAdd"), CheckBox).Checked)
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("pnlProyectoVisitaAcuerdoAdd"), Panel).Visible = False
            LimpiarAcuerdo()
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("dtlProyVisitaAcuerdoPVA"), DataList).DataBind()
            'SelPestaniaVisitas()
            'SelPestaniaVisitasAcuerdos()
        Catch concurrencyEx As DBConcurrencyException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlProyectoVisitasPV"), DataList).EditItemIndex + 1).FindControl("cuvDescAcuerdoPVAAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
...
#Region "ProyectoEtapa"
    ...
    Private Sub LimpiarEtapa()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNumEtapaPETAdd"), TextBox).Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtDescEtapaPETAdd"), TextBox).Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtDescMetaPETAdd"), TextBox).Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtActividadesPETAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInicioPETAdd"), UpdatePanel).FindControl("dtpkFechaInicioPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaTermPETAdd"), UpdatePanel).FindControl("dtpkFechaTermPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInfFinPETAdd"), UpdatePanel).FindControl("dtpkFechaInfFinPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtMontoMinPETAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaProgPETAdd"), UpdatePanel).FindControl("dtpkFechaProgPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaFactPETAdd"), UpdatePanel).FindControl("dtpkFechaFactPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNumProrrogaPETAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaRealPETAdd"), UpdatePanel).FindControl("dtpkFechaRealPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInfTecPETAdd"), UpdatePanel).FindControl("dtpkFechaInfTecPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtObservacionesPETAdd"), TextBox).Text = String.Empty
    End Sub

    Private Sub SelPestaniaEtapas()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnDatosGeneralesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_dg_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEtapasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_et_sel.gif"
        '**ELIMINADO** CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnProblematicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pr_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnParticipantesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pa_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEspeciesEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_es_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnEstadosEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_st_rep.gif"
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewEtapasEdt"), View))
    End Sub
    ...
    Protected Sub dtlEtapasPET_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoEtapasPETAdd"), Panel).Visible = False
        CurrentCveEtapa = -1
        LimpiarEtapa()
        CType(source, DataList).EditItemIndex = -1
        CType(source, DataList).SelectedIndex = -1
    ...
    Protected Sub dtlEtapasPET_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taEtapaProductos.FillByCveProyectoYCveEtapa(dtEtapaProductos, grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex))
            taProyectoEtapa.Delete(CType(source, DataList).DataKeys(e.Item.ItemIndex), grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value)
        ...
        Catch dataEx As DataException
            ...
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:032"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvInstalacionesPVAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub dtlEtapasPET_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        LimpiarEtapa()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsEtapasPET"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub dtlEtapasPET_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        'CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoEtapasPETAdd"), Panel).Visible = False
        'LimpiarEtapa()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsEtapasPET"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(sender, DataList).DataKeyField.ToString & " = " & CType(sender, DataList).DataKeys(CType(sender, DataList).SelectedIndex)
        CType(sender, DataList).SelectedIndex = 0
        CType(sender, DataList).DataBind()
    ...
    Protected Sub dtlEtapasPET_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoEtapa.ActualizarEtapa( _
                ...
                CType(source, DataList).DataKeys(e.Item.ItemIndex), grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value)
            CType(source, DataList).EditItemIndex = -1
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
    ...
    Protected Sub ibtnNuevoPETAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoEtapasPETAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlProyectoEtapasPETAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPETAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            '    grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNumEtapaPETAdd"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtDescEtapaPETAdd"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtDescMetaPETAdd"), TextBox).Text, _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtActividadesPETAdd"), TextBox).Text, _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInicioPETAdd"), UpdatePanel).FindControl("dtpkFechaInicioPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaTermPETAdd"), UpdatePanel).FindControl("dtpkFechaTermPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInfFinPETAdd"), UpdatePanel).FindControl("dtpkFechaInfFinPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CDec(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtMontoMinPETAdd"), TextBox).Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaProgPETAdd"), UpdatePanel).FindControl("dtpkFechaProgPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaFactPETAdd"), UpdatePanel).FindControl("dtpkFechaFactPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CInt(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtNumProrrogaPETAdd"), TextBox).Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaRealPETAdd"), UpdatePanel).FindControl("dtpkFechaRealPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CDate(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpFechaInfTecPETAdd"), UpdatePanel).FindControl("dtpkFechaInfTecPETAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtObservacionesPETAdd"), TextBox).Text)
            ...
            LimpiarEtapa()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaEtapas()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave" + ex.Message
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Finally
            taProyectoEtapa.Dispose()
        End Try
...
#Region "ProyectoEtapaProducto"
    ...
    Private Sub LimpiarProducto()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtProductoPEPAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("ddlTipoProductoPEPAdd"), DropDownList).SelectedIndex = -1
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtTituloPEPAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("chkbEntregadoPEPAdd"), CheckBox).Checked = False
        CType(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("updpFechaEntPEPAdd"), UpdatePanel).FindControl("dtpkFechaEntPEPAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtPalabrasClavePEPAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtDescripcionCortaPEPAdd"), TextBox).Text = String.Empty
    End Sub

    Private Sub SelPestaniaEtapasEtapa()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("ibtnProyectoEtapaPEPEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_et_sel.gif"
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("ibtnProyectoEtapaProductoPEPEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ep_rep.gif"
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("mviewEtapaProductoPEP"), MultiView).SetActiveView(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("viewEtapaPEP"), View))
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsEtapasPET"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).DataKeyField.ToString & " = " & CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).DataBind()
    End Sub

    Private Sub SelPestaniaEtapasProductos()
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("ibtnProyectoEtapaPEPEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_et_rep.gif"
    ...
    Protected Sub dtlProyectoEtapaProductoPEP_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("pnlProyectoEtapaProductoPEPAdd"), Panel).Visible = False
        LimpiarProducto()
        CType(source, DataList).EditItemIndex = -1
        CType(source, DataList).SelectedIndex = -1
        CType(source, DataList).DataBind()
    ...
    Protected Sub dtlProyectoEtapaProductoPEP_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            ...
            '    grdvProyectos.DataKeys(grdvProyectos.EditIndex), _
            '    CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex), _
            '    CType(source, DataList).DataKeys(e.Item.ItemIndex))
            taProyectoEtapaProducto.FillByCveProyectoCveEtapaCveProducto(dtProyectoEtapaProducto, _
                CveProyecto, _
                CveEtapa, _
        ...
        Catch concurrencyEx As DBConcurrencyException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            ...
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:036"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub ibtnNuevoPEPAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("pnlProyectoEtapaProductoPEPAdd"), Panel).Visible = Not CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("pnlProyectoEtapaProductoPEPAdd"), Panel).Visible
    End Sub

    'Protected Sub poloKISS(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Dim cveProyectoPolo As Label = CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("poloCveProyecto"), Label)
    '    Dim cveEtapaPolo As Label = CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("poloCveEtapa"), Label)
    '    cveProyectoPolo.Text = grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value
    '    cveEtapaPolo.Text = CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).DataKeys(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex)
    'End Sub
    ...
    Protected Sub ibtnGuardarPEPAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Dim panelAdd As Panel = CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("pnlProyectoEtapaProductoPEPAdd"), Panel)

        cuvGen = CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator)
        Try
            ...
            For i As Integer = 1 To 5
                Try
                    tempFile = CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd_" + i.ToString()), FileUpload)
                    cuvFile = CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvArchivoPEPAdd_" + i.ToString()), CustomValidator)
            ...
            If numeroArchivoCargados > 0 Then
                Try
                    ...
                    taProyectoEtapaProducto.InsertarProducto( _
                        CveEtapa, _
                        CveProyecto, _
                        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtProductoPEPAdd"), TextBox).Text, _
                        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtTituloPEPAdd"), TextBox).Text, _
                        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("chkbEntregadoPEPAdd"), CheckBox).Checked, _
                        CDate(CType(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("updpFechaEntPEPAdd"), UpdatePanel).FindControl("dtpkFechaEntPEPAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
                        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("ddlTipoProductoPEPAdd"), DropDownList).SelectedValue, _
                        textoFilesProductos, _
                        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtPalabrasClavePEPAdd"), TextBox).Text, _
                        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtDescripcionCortaPEPAdd"), TextBox).Text)
                ...
                Catch basura As Exception
                    ...
                    Response.Write(" 2: " & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value)
                    Response.Write(" 3: " & CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtProductoPEPAdd"), TextBox).Text)
                    Response.Write(" 4: " & CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtTituloPEPAdd"), TextBox).Text)
                    Response.Write(" 5: " & CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("chkbEntregadoPEPAdd"), CheckBox).Checked)
                    ...
                    Response.Write(" 7: " & CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("ddlTipoProductoPEPAdd"), DropDownList).SelectedValue)
                    Response.Write(" 8: " & PathProducts & CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName.Substring(CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName.LastIndexOfAny("\") + 1))
                End Try
                ...
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("pnlProyectoEtapaProductoPEPAdd"), Panel).Visible = False
                LimpiarProducto()
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("dtlProyectoEtapaProductoPEP"), DataList).DataBind()
                SelPestaniaEtapasProductos()
                'CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).DataBind()
                'SelPestaniaEtapas()
            Else
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "No existe un archivo para subir"
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "No existe un archivo para subir"
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
                'SelPestaniaEtapasProductos()
                'CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlEtapasPET"), DataList).DataBind()
...
#Region "ProyectoInfraestructura"
    ...
    Private Sub LimpiarInfraestructura()
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtMontoInfraPIAdd"), TextBox).Text = String.Empty
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpTipoInfraestructuraPIAdd"), UpdatePanel).FindControl("ddlTipoInfraestructuraPIAdd"), DropDownList).SelectedValue = -1
        CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpTipoInfraestructuraPIAdd"), UpdatePanel).FindControl("ddlInfraestructuraPIAdd"), DropDownList).SelectedValue = -1
    End Sub
    ...
    Private Sub SelPestaniaInfraestructura()
        ...
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_sg_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_ad_rep.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("ibtnInfraestructuraEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_in_sel.gif"
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("mviewProyectosEdt"), MultiView).SetActiveView(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("viewInfraestructuraEdt"), View))
    End Sub
    ...
    Protected Sub dtlInfraestructuraPI_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlInfraestructuraPIAdd"), Panel).Visible = False
    ...
    Protected Sub dtlInfraestructuraPI_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoInfraestructura.Delete(grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlInfraestructuraPIAdd"), Panel).Visible = False
            LimpiarInfraestructura()
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            ...
            'SelPestaniaEtapas()
        Catch concurrencyEx As DBConcurrencyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "No se pueden guardar los datos porque la base de datos esta siendo utilizada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch constraintEx As ConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Error de llaves duplicadas"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch deletedRowEx As DeletedRowInaccessibleException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Fila no accesible"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch duplicateNameEx As DuplicateNameException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Nombre duplicado"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch inRowChangingEx As InRowChangingEventException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Fila esta siendo modificada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch invalidConstraintEx As InvalidConstraintException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Restricción no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch invalidExpressionEx As InvalidExpressionException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Expresión no válida"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch missingPrimaryEx As MissingPrimaryKeyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "No se encontró una llave principal"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch noNullEx As NoNullAllowedException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Valor nulo no permitido"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch readOnlyEx As ReadOnlyException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "La base de datos es de solo lectura"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch rowNotInTableEx As RowNotInTableException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "La fila solicitada no esta en la base de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch strongTypingEx As StrongTypingException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Error en tipos de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch typedDataSetEx As TypedDataSetGeneratorException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "No fue posible generar el conjunto de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch versionNotFoundEx As VersionNotFoundException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Versión no encontrada"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch dataEx As DataException
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Error de datos"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:038"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cuvTipoInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Finally
    ...
    Protected Sub dtlInfraestructuraPI_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlInfraestructuraPIAdd"), Panel).Visible = False
        LimpiarInfraestructura()
        'CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsInfraestructuraPI"), ObjectDataSource).FilterExpression = grdvProyectos.DataKeyNames(0) & " = '" & grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value & "' AND " & CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("odsInfraestructuraPI"), ObjectDataSource).FilterExpression = CType(source, DataList).DataKeyField.ToString & " = " & CType(source, DataList).DataKeys(e.Item.ItemIndex)
        CType(source, DataList).EditItemIndex = 0
        CType(source, DataList).DataBind()
    End Sub
    ...
    Protected Sub ibtnNuevoPIAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlInfraestructuraPIAdd"), Panel).Visible = Not CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlInfraestructuraPIAdd"), Panel).Visible
    End Sub
    ...
    Protected Sub ibtnGuardarPIAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taProyectoInfraestructura.Insert( _
                grdvProyectos.DataKeys(grdvProyectos.EditIndex).Value, _
                CType(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("updpTipoInfraestructuraPIAdd"), UpdatePanel).FindControl("ddlInfraestructuraPIAdd"), DropDownList).SelectedValue, _
                CDec(CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("txtMontoInfraPIAdd"), TextBox).Text))
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("pnlInfraestructuraPIAdd"), Panel).Visible = False
            LimpiarInfraestructura()
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("dtlInfraestructuraPI"), DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + grdvProyectos.DataKeys(grdvProyectos.EditIndex) + "'"
            'grdvProyectos.DataBind()
            'SelPestaniaEtapas()
        Catch ex As Exception
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cvInfraestructuraPIAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave" & ex.Message
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cvInfraestructuraPIAdd"), CustomValidator).ToolTip = "Ocurrió un error al intentar guardar"
            CType(grdvProyectos.Rows(grdvProyectos.EditIndex).FindControl("cvInfraestructuraPIAdd"), CustomValidator).IsValid = False
        Finally
            taProyectoInfraestructura.Dispose()
        End Try

<%@ Page Language="VB" MasterPageFile="~/mpInterna.master" AutoEventWireup="false" CodeFile="RegistroProyectos.aspx.vb" Inherits="RegistroProyectos2" title="Proyectos" %>
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlNavegacionUp" runat ="server" Visible="true" Width="100%">
                    <table width="90%" align="center" class="tablaComun">    
                    <tr>
                        <td style="width:25%;"><asp:ImageButton ID="ibtnNuevoUp" runat="server" CssClass="boton" ImageUrl="~/images/aplicacion/btnNuevo.gif" CommandName="New" /></td>
                        <td style="width:25%;"></td>
                        <td style="width:25%;"><asp:Label ID="lblTotalProyectosUP" runat="server" Text="0 proyectos encontrados"></asp:Label></td>
                                                ...
                                                <table align="center" border="0" cellpadding="3" cellspacing="0" width="90%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            ...
                                                            <asp:HiddenField ID="hdnfFechaCapturaEdt" runat="server" Value='<%# Bind("FechaCaptura", "{0:d}") %>' />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 30%">
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtNombreEdt" runat="server" MaxLength="300" Rows="4" Text='<%# Bind("NombreProyecto") %>'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlResponsableTecnicoEdt" runat="server"
                                                                ...
                                                                SelectedValue='<%# Bind("CveResponsableTecnico") %>'>
                                                            </asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        <td style="width: 30%">
                                                            Resumen</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtResumenEdt" runat="server" MaxLength="1073741823" Rows="4" Text='<%# Bind("Resumen") %>'
                                                    ...
                                                    <tr>
                                                        <td style="width: 30%">
                                                            Objetivo general</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtObjetivoGralEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("ObjetivoGeneral") %>'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtObjetivosEspEdt" runat="server" MaxLength="4000" Rows="4" Text='<%# Bind("ObjetivosEspecificos") %>'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlTipoProyectoEdt" runat="server" DataSourceID="odsTipoProyectoDDLEdt"
                                                                DataTextField="DesTipoProy" DataValueField="CveTipoProy" SelectedValue='<%# Bind("CveTipoProy") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlTipoApoyoEdt" runat="server" DataSourceID="odsTipoApoyoDDLEdt"
                                                                DataTextField="DesTipoApoyo" DataValueField="CveTipoApoyo" SelectedValue='<%# Bind("CveTipoApoyo") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlAreaTematicaEdt" runat="server" DataSourceID="odsAreaTematicaDDLEdt"
                                                                DataTextField="AreaTematica" DataValueField="CveAreaTematica" Width="400px" SelectedValue='<%# Bind("CveAreaTematica") %>'>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlInstitucionEdt" runat="server" DataSourceID="odsInstitucionDDLEdt"
                                                                DataTextField="DesInstitucion" DataValueField="CveInstitucion" SelectedValue='<%# Bind("CveInstitucion") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            $<asp:TextBox ID="txtCostoTotalProyectoEdt" runat="server" Columns="12" MaxLength="10" Text='<%# Bind("CostoTotalProyecto","{0:F2}") %>'></asp:TextBox><asp:RequiredFieldValidator ID="rfvCostoTotalProyectoEdt"
                                                                ...
                                                                ToolTip="Costo total del proyecto es un valor requerido">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revCostoTotalProyectoEdt"
                                                                ...
                                                                ValidationExpression="^([0-9]{1,}|[0-9]{0,}\.[0-9]{0,})$">x</asp:RegularExpressionValidator></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <table border="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        $<asp:TextBox ID="txtAportacionApoyoInstitucionalEdt" runat="server" Columns="12" MaxLength="10" Text='<%# Bind("AportacionApoyoInstitucional","{0:F2}") %>'></asp:TextBox><asp:RequiredFieldValidator ID="rfvAportacionApoyoInstitucionalEdt"
                                                                            ...
                                                                            ToolTip="La aportacion de apoyo institucional es un valor requerido">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revAportacionApoyoInstitucionalEdt"
                                                                            ...
                                                                            ValidationExpression="^([0-9]{1,}|[0-9]{0,}\.[0-9]{0,})$">x</asp:RegularExpressionValidator></td>
                                                                    <td>
                                                                        $<asp:TextBox ID="txtAportacionInstitucionEjecutoraEdt" runat="server" Columns="12" MaxLength="10" Text='<%# Bind("AportacionInstitucionEjecutora","{0:F2}") %>'></asp:TextBox><asp:RequiredFieldValidator ID="rfvAportacionInstitucionEjecutoraEdt"
                                                                            ...
                                                                            ToolTip="La aportacion de la institucional ejecutora es un valor requerido">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revAportacionInstitucionEjecutoraEdt"
                                                                            ...
                                                                            ValidationExpression="^([0-9]{1,}|[0-9]{0,}\.[0-9]{0,})$">x</asp:RegularExpressionValidator></td>
                                                                    <td>
                                                                        $<asp:TextBox ID="txtAportacionesOtrasEdt" runat="server" Columns="12" MaxLength="10" Text='<%# Bind("AportacionesOtras","{0:F2}") %>'></asp:TextBox><asp:RequiredFieldValidator ID="rfvAportacionesOtrasEdt"
                                                                            runat="server" ControlToValidate="txtAportacionesOtrasEdt" ForeColor="" 
                                                                            ErrorMessage="Otras aportaciones es un valor requerido"
                                                                            ToolTip="Otras aportaciones es un valor requerido">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revAportacionesOtrasEdt"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlAnioConvEdt" runat="server" DataSourceID="odsAnioConvocatoriaEdt"
                                                                DataTextField="Anio" DataValueField="Anio" SelectedValue='<%# Bind("AnioConvocatoria") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlEscalaEdt" runat="server" DataSourceID="odsEscalaDDLEdt"
                                                                DataTextField="DesEscala" DataValueField="CveEscala" SelectedValue='<%# Bind("CveEscala") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlVegetacionEdt" runat="server" DataSourceID="odsVegetacionDDLEdt"
                                                                DataTextField="DesVegetacion" DataValueField="CveVegetacion" SelectedValue='<%# Bind("CveVegetacion") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlEcosistemaEdt" runat="server" DataSourceID="odsEcosistemaDDLEdt"
                                                                DataTextField="Descripcion" DataValueField="CveEcosistema" SelectedValue='<%# Bind("CveEcosistema") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtMetodologiaEdt" runat="server" MaxLength="1073741823" Rows="4"
                                                                Text='<%# Bind("Metodologia") %>' TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RequiredFieldValidator
                                                    ...
                                                    <tr>
                                                        <td style="width: 30%">
                                                            Demanda</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtDemandaEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("Demanda") %>'
                                                    ...
                                                    <tr>
                                                        <td style="width: 30%">
                                                            Demandante</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtDemandanteEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("Demandante") %>'
                                                                TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RegularExpressionValidator
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtResEsperadosEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("ResultadosEsp") %>'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtImpactosEsperadosEdt" runat="server" Rows="4"
                                                                Text='<%# Bind("ImpactosEsperados") %>' TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RegularExpressionValidator
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtIdentProblemaEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("IdentProblema") %>'
                                                                TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RegularExpressionValidator
                                                    ...
                                                    <tr style="display:none;">
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtCoberturaOperativaEdt" runat="server" MaxLength="500" Rows="4"
                                                                Text='<%# Bind("CoberturaOperativa") %>' TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RegularExpressionValidator ID="revCoberturaOperativaEdt" runat="server" ControlToValidate="txtCoberturaOperativaEdt"
                                                                ...
                                                                &nbsp;<asp:UpdatePanel ID="uppaFechaConvenioAcuerdoEdt" runat="server">
                                                                    <ContentTemplate>
                                                                        <ews:DatePicker ID="dpkrFechaConvAcueEdt" runat="server" CalendarPosition="DisplayRight"
                                                                            DateValue='<%# Bind("FechaConvAcue") %>' ExpandButtonImage="~/images/aplicacion/show-calendar1.gif" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlEstatusEdt" runat="server" DataSourceID="odsEstatusDDLEdt"
                                                                DataTextField="DesEstatus" DataValueField="CveEstatus" SelectedValue='<%# Bind("CveEstatus") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        <td style="width: 30%">
                                                            Usuario destino</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtUsuarioTTEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("Usuario") %>'
                                                                TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RegularExpressionValidator
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%">
                                                            <asp:DropDownList ID="ddlSectorUsuarioTTEdt" runat="server" DataSourceID="odsSectorUsuarioDDLEdt"
                                                                DataTextField="DescSectorUsuario" DataValueField="CveSectorUsuario" SelectedValue='<%# Bind("CveSectorUsuario") %>'
                                                                Width="400px">
                                                    ...
                                                    <tr>
                                                        <td style="width: 30%">
                                                            Materiales</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtMaterialesTTEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("Materiales") %>'
                                                                TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RegularExpressionValidator
                                                    ...
                                                    <tr>
                                                        <td style="width: 30%">
                                                            Requisitos</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtRequisitosTTEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("RequisitosTT") %>'
                                                                TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RegularExpressionValidator
                                                    ...
                                                    <tr>
                                                        <td style="width: 30%">
                                                            Actividades</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtActividadesTTEdt" runat="server" MaxLength="1000" Rows="4" Text='<%# Bind("ActividadesTT") %>'
                                                                TextMode="MultiLine" Width="400px"></asp:TextBox><asp:RegularExpressionValidator
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 52%">
                                                                                &nbsp;<asp:LinkButton ID="lnkbInstalacionesPVItm" runat="server" CommandName="Select"
                                                                                    Text='<%# Eval("Instalaciones") %>'></asp:LinkButton></td>
                                                                            <td style="width: 16%" align="right">
                                                            ...
                                                            <asp:Panel ID="pnlInfraestructuraPIAdd" runat="server" Width="100%" Visible="False">
                                                                <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tablaEditarTemplate">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 70%">
                                                                            <asp:CustomValidator ID="cvInfraestructuraPIAdd" runat="server" ErrorMessage="" ForeColor="">x</asp:CustomValidator>
            ...
            <td>
                <table align="center" border="0" cellpadding="3" cellspacing="0" width="90%">
                            ...
                            <tr>
                                <td>Costo TOTAL del proyecto</td>
                                <td>
                                    $<asp:TextBox ID="txtCostoTotalProyectoAdd" runat="server" Columns="12" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator ID="rfvCostoTotalProyectoAdd"
                                        runat="server" ControlToValidate="txtCostoTotalProyectoAdd" ForeColor="" 
                                        ErrorMessage="Costo total del proyecto es un valor requerido"
                                        ToolTip="Costo total del proyecto es un valor requerido">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revCostoTotalProyectoAdd"
                            ...
                            <tr>
                                <td colspan="2">
                                    <table border="0" width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                $<asp:TextBox ID="txtAportacionApoyoInstitucionalAdd" runat="server" Columns="12" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator ID="rfvAportacionApoyoInstitucionalAdd"
                                                    runat="server" ControlToValidate="txtAportacionApoyoInstitucionalAdd" ForeColor="" 
                                                    ErrorMessage="La aportacion de apoyo institucional es un valor requerido"
                                                    ToolTip="La aportacion de apoyo institucional es un valor requerido">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revAportacionApoyoInstitucionalAdd"
                                                    runat="server" ControlToValidate="txtAportacionApoyoInstitucionalAdd"
                                                    ErrorMessage="La aportacion de apoyo institucional tiene caracteres no permitidos" ForeColor=""
                                                    ToolTip="La aportacion de apoyo institucional tiene caracteres no permitidos" 
                                                    ValidationExpression="^([0-9]{1,}|[0-9]{0,}\.[0-9]{0,})$">x</asp:RegularExpressionValidator></td>
                                            <td>
                                                $<asp:TextBox ID="txtAportacionInstitucionEjecutoraAdd" runat="server" Columns="12" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator ID="rfvAportacionInstitucionEjecutoraAdd"
                                                    runat="server" ControlToValidate="txtAportacionInstitucionEjecutoraAdd" ForeColor="" 
                                                    ErrorMessage="La aportacion de la institucional ejecutora es un valor requerido"
                                                    ToolTip="La aportacion de la institucional ejecutora es un valor requerido">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revAportacionInstitucionEjecutoraAdd"
                                                    runat="server" ControlToValidate="txtAportacionInstitucionEjecutoraAdd"
                                                    ErrorMessage="La aportacion de la institucional ejecutora tiene caracteres no permitidos" ForeColor=""
                                                    ToolTip="La aportacion de la institucional ejecutora tiene caracteres no permitidos" 
                                                    ValidationExpression="^([0-9]{1,}|[0-9]{0,}\.[0-9]{0,})$">x</asp:RegularExpressionValidator></td>
                                            <td>
                                                $<asp:TextBox ID="txtAportacionesOtrasAdd" runat="server" Columns="12" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator ID="rfvAportacionesOtrasAdd"
                                                    runat="server" ControlToValidate="txtAportacionesOtrasAdd" ForeColor="" 
                                                    ErrorMessage="Otras aportaciones es un valor requerido"
                                                    ToolTip="Otras aportaciones es un valor requerido">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revAportacionesOtrasAdd"
